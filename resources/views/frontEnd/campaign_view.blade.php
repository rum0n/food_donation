            ...
            <div class="row">
                <div class="col-12 col-lg-10 col-md-10 offset-md-1 offset-lg-1">
                    <div class="cause-wrap d-flex flex-wrap justify-content-between">
                        <div class="centered ">
                            <figure class="m-0">
                                <img src="{{ asset('/campaign_pics/'.$campaign->picture)}}" alt="Campaign Pictures">
                        ...
                        <div class="cause-content-wrap mt-5">
                            <header class="entry-header d-flex flex-wrap align-items-center">
                                <h3 class="entry-title w-100 m-0"><a>{{ $campaign->name }}</a></h3>

                                <span class="mr-1">Created at :</span><span class="text-info">{{  \Carbon\Carbon::parse($campaign->created_at)->diffForHumans() }}</span>

                                {{--<div class="posted-date">--}}
                                    {{--<a>{{ Carbon\Carbon::parse($campaign->created_at)->diffForHumans() }}</a>--}}
                                {{--</div><!-- .posted-date -->--}}
                            ...
                            <div class="entry-content">
                                <p class="m-0">{{ $campaign->description }}.</p>
                            </div><!-- .entry-content -->
